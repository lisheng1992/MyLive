...
#define LOGI(FORMAT,...) __android_log_print(ANDROID_LOG_INFO,"liwinner",FORMAT,##__VA_ARGS__)
#define LOGE(FORMAT,...) __android_log_print(ANDROID_LOG_ERROR,"liwinner",FORMAT,##__VA_ARGS__)
...
JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_startPush
...
JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_stopPush
  (JNIEnv *env, jobject jobj){
	is_pushing = FALSE;
}


JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_release
  (JNIEnv *env, jobject jobj){
 ...
 * 设置视频参数
 */
JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_setVideoOptions
 ...
 * 音频编码器配置
 */
JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_setAudioOptions
 ...
 * 将采集到视频数据进行编码
 */
JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_fireVideo
 ...
 * 对音频采样数据进行AAC编码
 */
JNIEXPORT void JNICALL Java_com_liwinner_mylive_jni_PusherNative_fireAudio
